...
bpmn = pm.read_bpmn(str(path/"Order-to-Cash-Model-1.bpmn"))
#pm.view_bpmn(bpmn)
...
to_case_table(cases, activities, frame).to_csv(path/"test.csv", index=False)

import sim_func
scebarios = {'name': sim_func.act_name}
